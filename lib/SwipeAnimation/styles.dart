...
DecorationImage image1 = new DecorationImage(
  image: new ExactAssetImage('assets/alex.jpg'),
  fit: BoxFit.cover,
);
DecorationImage image2 = new DecorationImage(
  image: new ExactAssetImage('assets/aly.jpg'),
  fit: BoxFit.cover,
);

DecorationImage image3 = new DecorationImage(
  image: new ExactAssetImage('assets/jason.jpg'),
  fit: BoxFit.cover,
);
DecorationImage image4 = new DecorationImage(
  image: new ExactAssetImage('assets/nick.jpg'),
  fit: BoxFit.cover,
);
DecorationImage image5 = new DecorationImage(
  image: new ExactAssetImage('assets/pedro.jpg'),
  fit: BoxFit.cover,
);
